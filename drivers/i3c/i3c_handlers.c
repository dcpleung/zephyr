...
static uint32_t copy_i2c_msgs_and_transfer(struct i3c_i2c_device_desc *i2c_dev,
					   ...
					   uint8_t num_msgs)
{
	...
	return z_impl_i3c_i2c_transfer(i2c_dev, copy, num_msgs);
}

static inline int z_vrfy_i3c_i2c_transfer(struct i3c_i2c_device_desc *i2c_dev,
					  struct i2c_msg *msgs, uint8_t num_msgs)
{
	Z_OOPS(Z_SYSCALL_MEMORY_READ(i2c_dev, sizeof(*i2c_dev)));
	Z_OOPS(Z_SYSCALL_OBJ(i2c_dev->bus, K_OBJ_DRIVER_I3C));
	...
	return copy_i2c_msgs_and_transfer((struct i3c_i2c_device_desc *)i2c_dev,
					  (struct i2c_msg *)msgs,
					  (uint8_t)num_msgs);
}
#include <syscalls/i3c_i2c_transfer_mrsh.c>
